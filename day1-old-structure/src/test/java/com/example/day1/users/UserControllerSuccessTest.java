...
class UserControllerSuccessTest {
    ...
    void createUserWithSuccess() {
        ...
        userRequest.setFirstName("User 4");
        userRequest.setLastName("Lastname 4");
        ...
        assertEquals("User 4", userRequest.getFirstName());
        assertEquals("Lastname 4", userRequest.getLastName());
    }
